...
<?php $__env->startPush('title'); ?>Edit Store <?php $__env->stopPush(); ?>
...
<div class="content-header">
	<div class="container-fluid">
		...
		<div class="card card-outline card-primary">
			<form action="<?php echo e(route('store.update',$obj->id)); ?>" id="storeFrm" name="storeFrm" method="post" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sugerloaf_admin\resources\views/admin/store/edit.blade.php ENDPATH**/ ?>