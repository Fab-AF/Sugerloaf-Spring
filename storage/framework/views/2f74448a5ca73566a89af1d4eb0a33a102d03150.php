        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="<?php echo e(Auth::user()->user_photo); ?>"
...
<script src="<?php echo e(asset('js/toster.js')); ?>"></script>
<script src="<?php echo e(asset('js/admin/global.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\listingpix_backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>