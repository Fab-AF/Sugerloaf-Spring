...
<main>
    <div id="home">
        <?php if(!empty($homeObj->description)): ?>
        <?php echo filterEditorContent($homeObj->description); ?>

        <?php endif; ?>
    </div>
    <div id="tasting">
        <?php if(!empty($tastingObj->description)): ?>
        <?php echo filterEditorContent($tastingObj->description); ?>

        <?php endif; ?>
    </div>
    <div id="our-brands">
        <?php if(!empty($ourBrandObj->description)): ?>
        <?php echo filterEditorContent($ourBrandObj->description); ?>
...
<script src="<?php echo e(asset('js/public/home.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sugerloaf-Spring\resources\views/home.blade.php ENDPATH**/ ?>